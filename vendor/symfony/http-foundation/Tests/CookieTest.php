...
class CookieTest extends TestCase
{
    ...
    public function testToString()
    {
        ...
        $cookie = new Cookie('foo', null, 1, '/index/', '.myfoodomain.com');
        $this->assertEquals('foo=deleted; expires='.gmdate('D, d-M-Y H:i:s T', $expire = time() - 31536001).'; max-age='.($expire - time()).'; path=/index/; domain=.myfoodomain.com; httponly', (string) $cookie, '->__toString() returns string representation of a cleared cookie if value is NULL');
